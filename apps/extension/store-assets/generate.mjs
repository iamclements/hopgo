...
const s1 = `<svg xmlns="http://www.w3.org/2000/svg" width="1280" height="800">
  ...
  <!-- Domain dropdown -->
  <rect x="918" y="86" width="104" height="22" rx="5" fill="rgba(37,99,235,0.15)" stroke="rgba(59,130,246,0.25)" stroke-width="1"/>
  <text x="951" y="101" font-family="${MONO}" font-size="10" fill="${BLUE_BRIGHT}" text-anchor="middle">go.acme.dev</text>
  <text x="1014" y="100" font-family="${FONT}" font-size="9" fill="${BLUE_BRIGHT}">▾</text>
  <!-- Gear icon -->
  <path d="M1155 90 a4 4 0 1 0 0 8 a4 4 0 0 0 0-8zM1162 95a2.2 2.2 0 0 0 .44 2.43l.08.08a2.67 2.67 0 0 1-3.78 3.78l-.08-.08a2.2 2.2 0 0 0-2.43-.44 2.2 2.2 0 0 0-1.33 2V103a2.67 2.67 0 0 1-5.33 0v-.12a2.2 2.2 0 0 0-1.44-2 2.2 2.2 0 0 0-2.43.44l-.08.08a2.67 2.67 0 0 1-3.78-3.78l.08-.08A2.2 2.2 0 0 0 1142.33 95a2.2 2.2 0 0 0-2-1.33H1140a2.67 2.67 0 0 1 0-5.33h.12a2.2 2.2 0 0 0 2-1.44 2.2 2.2 0 0 0-.44-2.43l-.08-.08a2.67 2.67 0 0 1 3.78-3.78l.08.08a2.2 2.2 0 0 0 2.43.44 2.2 2.2 0 0 0 1.33-2V79a2.67 2.67 0 0 1 5.33 0v.12a2.2 2.2 0 0 0 1.33 2 2.2 2.2 0 0 0 2.43-.44l.08-.08a2.67 2.67 0 0 1 3.78 3.78l-.08.08A2.2 2.2 0 0 0 1162 87a2.2 2.2 0 0 0 2 1.33H1164a2.67 2.67 0 0 1 0 5.33h-.12a2.2 2.2 0 0 0-2 1.33z" stroke="${FAINT}" stroke-width="1.2" fill="none" stroke-linecap="round" stroke-linejoin="round"/>
  ...
  <!-- Slug field -->
  <text x="838" y="206" font-family="${MONO}" font-size="9" letter-spacing="1.2" fill="${FAINT}">YOUR SHORT LINK <tspan fill="${FAINT}" opacity="0.5">(optional)</tspan></text>
